...
public class YTHttpHandler {
	...
	public String doClientPost(String reqStr, String uri) {
		try {
			/*org.apache.commons.httpclient.HttpClient client = new org.apache.commons.httpclient.HttpClient();
			// HttpClient client = new HttpClient();
			//client.getHostConfiguration().set
			client.getHostConfiguration().setHost("182.150.20.24",10029,"http");
			org.apache.commons.httpclient.HttpMethod method = getPostMethod(reqStr);// 使用POST方式提交数据
