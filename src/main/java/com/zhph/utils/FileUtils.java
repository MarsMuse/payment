...
public class FileUtils {
    ...
    public static void Copy(String oldPath, String newPath)
        ...
        int byteread = 0;
        /** 改成读取resource路径**/
        //原 File oldfile = new File(oldPath);
        String oldPathAll =  FileUtils.class.getClassLoader().getResource(oldPath).toString();
        /** oldPathAll  样式为  file:/D:/Workspaces/IdeaWork/svn/zhph_paymentPlatform/target/classes/exTemplate/platform.xls**/
        oldPath = oldPathAll.substring(5);
        ...
        if (oldfile.exists()) {
            ...
            sBuilder.append("文件不存在:");
            sBuilder.append(oldPath);
