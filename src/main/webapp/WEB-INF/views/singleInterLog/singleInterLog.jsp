...
<script  type="text/javascript">
    ...
    function  getJudgeInfor(gridHandler, page){
        ...
        /* queryData.push(page); */
        $.ajax({
            url:"${path}/action/singleInterLog/singleInterLogList.do",
            method:"post",
            data:queryData,
            dataType:"json"
    ...
    var tbOptions = {
        ...
        columns : [
            ...
            {
                field: 'interfaceContent',
                title: '报文内容',
                formatter:function(value , rowEntity , index){
                    return "<a onclick =openFj('"+rowEntity.priNumber+"')>报文</a>";
                }
            },
            {
                field: 'createTime',
    ...
    function exportDataByButton(){
        ...
        form.action = "${pageContext.request.contextPath}/action/singleInterLog/exportData.do";
        form.submit();
    }

    function openFj(number) {
        console.log(number);

        $.ajax({
            url:"${path}/action/singleInterLog/queryInterfaceContent.do",
            method:"post",
            data:{"priNumber":number},
            dataType:"json"
        }).success(function(data){
            console.log(data);
            if(null != data && null != data.result){
                var xmlVal = data.result;
